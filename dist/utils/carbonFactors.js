...
exports.carbonFactors = void 0;
exports.initCarbonFactors = initCarbonFactors;
exports.getCarbonFactor = getCarbonFactor;
exports.getAllCarbonFactors = getAllCarbonFactors;
const fs_1 = require("fs");
const path_1 = require("path");
// Basic carbon factors database (kg CO2e per unit)
exports.carbonFactors = {
    transportation: {
        car_gasoline: {
...
function initCarbonFactors() {
    try {
        const dataPath = (0, path_1.join)(process.cwd(), 'data');
        const factorsPath = (0, path_1.join)(dataPath, 'carbon-factors.json');
        ...
        (0, fs_1.writeFileSync)(factorsPath, JSON.stringify(exports.carbonFactors, null, 2));
...
function getCarbonFactor(category, type) {
    const categoryData = exports.carbonFactors[category];
    if (!categoryData)
        return null;
...
function getAllCarbonFactors() {
    return exports.carbonFactors;
}
//# sourceMappingURL=carbonFactors.js.map