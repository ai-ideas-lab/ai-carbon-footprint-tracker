...
- 各类别分布：
${Object.entries(byCategory).map(([category, emission]) => `- ${category}: ${emission.toFixed(2)} kg CO2e (${(emission / totalEmission) * 100).toFixed(1)}%)`;
            join('\n');
        }
        finally {
        }
